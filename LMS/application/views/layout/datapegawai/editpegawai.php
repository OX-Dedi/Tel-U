...
<div class="form-group row">
    <label for="username_pegawai_edit" class="col-sm-4 col-form-label">Username Mahasiswa</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="username_pegawai_edit" name="username_pegawai_edit" value="<?= $datapegawai['username'] ?>">
    </div>
</div>
<div class="form-group row">
    <label for="password_pegawai_edit" class="col-sm-4 col-form-label">Password Mahasiswa</label>
    <div class="col-sm-8">
...
<div class="form-group row">
    <label for="kode_pegawai_edit" class="col-sm-4 col-form-label">Kode Mahasiswa</label>
    <div class="col-sm-8">
...
<div class="form-group row">
    <label for="jabatan_pegawai_edit" class="col-sm-4 col-form-label">NIM/NIP</label>
    <div class="col-sm-8">
...
<div class="form-group row">
    <label for="npwp_pegawai_edit" class="col-sm-4 col-form-label">Tahun Masuk</label>
    <div class="col-sm-8">
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?= form_dropdown('role_pegawai_edit', ['' => 'Select Role', 1 => 'Administrator', 2 => 'Guru', 3 => 'Mahasiswa'], set_value('role_pegawai_edit', $datapegawai['role_id']), 'class="form-control" id="role_pegawai_edit"'); ?>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    <label for="shift_pegawai_edit" class="col-sm-4 col-form-label">Jenis Kelas</label>
    <div class="col-sm-8">
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="shift_pegawai_edit1">Reguler Pagi</label>
        </div>
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="shift_pegawai_edit2">Reguler Malam</label>
        </div>
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="shift_pegawai_edit3">Karyawan</label>
        </div>
    </div>
</div>
<div class="form-group row">
    <label for="verifikasi_pegawai_edit" class="col-sm-4 col-form-label">Verifikasi Account</label>
    <div class="col-sm-8">
        <div class="form-check form-check-inline">
...
<div class="form-group row">
    <label for="barcode_pegawai" class="col-sm-4 col-form-label">Buat Barcode Account</label>
    <div class="col-sm-8">
...
<div class="form-group row">
    <div class="col-sm-2">Pas Foto Mahasiswa</div>
    <div class="col-sm-10">
        <div class="row">
            <div class="col-sm-3">
