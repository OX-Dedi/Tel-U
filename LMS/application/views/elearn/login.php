...
<head>
	...
	<link rel="icon" href="http://localhost/Push/LMS/asset/image/icon.png">

	<link rel="stylesheet" href="http://localhost/Push/LMS/asset/css/fonts.google.css" />

	<link rel="stylesheet" href="http://localhost/Push/LMS/asset/css/bootstrap.min.css" />
	<link rel="stylesheet" href="http://localhost/Push/LMS/asset/css/datatables.min.css" />

	<link rel="stylesheet" href="http://localhost/Push/LMS/asset/css/font-awesome.min.css">
	...
	<div class="container">
		<div class="row" id="logindiv">	
			<div class="col-md-12">
				...
				<img src="http://localhost/Push/LMS/asset/image/login.jpg" class="img-responsive">
		        </div>		
		...
		<div class="row" id="signupdiv" style="display: none;">
			<div class="col-md-12">
				...
				<img src="http://localhost/Push/LMS/asset/image/signup.png" class="img-responsive">
		        </div>				
...
<script src="http://localhost/Push/LMS/asset/js/jquery.min.js"></script>
<script src="http://localhost/Push/LMS/asset/js/menu-scrollbar.min.js"></script>
<script src="http://localhost/Push/LMS/asset/js/application.js"></script>
...
<script type="text/javascript">
    ...
    function submitLoginForm(){
        ...
        $.ajax({
            url: "<?php echo base_url('Elearning_Auth/check_elearn')?>",
            type: 'POST',
