<div class="container-fluid">
    <div class="mt-4 jumbotron jumbotron-fluid shadow-lg bg-white">
        <div class="container">
            ...
            <div class="card mb-4">
                    ...
                    <div class="row detail">
                        ...
                        <div class="col-md-10 col-sm-8 col-6">
                            <dl class="row">
                                ...
                                <dt class="col-sm-5">Role Mahasiswa:</dt>
                                <dd class="col-sm-7"><?= $shiftpegawai = ($user['bagian_shift'] == 1) ? '<span class="badge badge-success">Reguler Pagi</span>' : (($user['bagian_shift'] == 2) ? '<span class="badge badge-warning">Reguler Malam</span>' : '<span class="badge badge-primary">Karyawan</span>'); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Kode Mahasiswa: <?= $user['kode_pegawai'] ?></div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title text-center" id="qrcodemodallabel"><span class="fas fa-qrcode mr-1"></span>QR Code User</h5>
            </div>
            <div class="modal-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-5">Tahun Masuk:</dt>
                    <dd class="col-sm-7"><?= $user['npwp'] ?></dd>
                    <dt class="col-sm-5">Kode User:</dt>
